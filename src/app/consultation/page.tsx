    ...
    <main className="w-full overflow-x-hidden">
      ...
      >
        ...
        <p style={{
          ...
          این جلسه برای همه مناسب نیست. هر درخواست به‌صورت جداگانه بررسی می‌شود. اگر احساس کنم این جلسه می‌تواند برای شرایطت ارزشمند باشد، برای هماهنگی مرحله بعد با تو تماس می‌گیریم.
        </p>
