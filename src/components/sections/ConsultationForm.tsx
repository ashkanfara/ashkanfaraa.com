    ...
    return (
      ...
      >
        ...
        <p style={{ fontSize: '0.9rem', color: 'var(--muted)', lineHeight: 2, marginBottom: '0.75rem' }}>
          اشکان جان ابتدا شرایط شما را بررسی می‌کند.
        </p>

        <p style={{ fontSize: '0.9rem', color: 'var(--muted)', lineHeight: 2, margin: 0 }}>
          اگر احساس کنیم این جلسه می‌تواند برای شرایط شما ارزش واقعی داشته باشد، اطلاعات مرحله بعد برایتان ارسال خواهیم کرد.
        </p>
      </div>
    )
  }
