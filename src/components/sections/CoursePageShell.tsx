...
// ── Topics ─────────────────────────────────────────────────────
const TOPICS = [
  'چرا بعضی افراد بعد از مهاجرت به آزادی بیشتری می‌رسند و بعضی دیگر احساس می‌کنند چیزی را در مسیر جا گذاشته‌اند.',
  'تفاوت بین رویای مهاجرت و زندگی‌ای که بعد از فرودگاه شروع می‌شود.',
  'تصمیم‌هایی که قبل از مهاجرت کوچک به نظر می‌رسند اما سال‌ها بعد اثرشان دیده می‌شود.',
  'پول، کار و کیفیت زندگی؛ واقعیت‌هایی که معمولاً در ویدیوهای مهاجرتی جایی ندارند.',
  'تنهایی، تعلق، دوستی و رابطه؛ ساختن زندگی جدید در جایی که از صفر شروع می‌کنی.',
  'فرزند، خانواده و آینده؛ مهاجرتی که برای نسل بعد انجام می‌شود چه هزینه‌هایی دارد؟',
  'چرا بعضی افراد از مهاجرت راضی هستند و بعضی دیگر با وجود رسیدن به مقصد هنوز احساس موفقیت نمی‌کنند.',
  'چیزهایی که اگر قبل از مهاجرت می‌دانستم، بعضی تصمیم‌ها را متفاوت می‌گرفتم.',
]
