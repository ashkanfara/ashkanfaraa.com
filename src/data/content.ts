  ...
  items: [
    {
      ...
      quote: 'نمی‌دانستم چقدر چیزهایی هست که قبل از رفتن باید می‌دانستم. اشکان آن‌ها را با صراحت گفت.',
    ...
    },
    {
      ...
      quote: 'به جای اینکه فقط اطلاعات بدهد، کمک کرد تصمیم درست را خودم بگیرم.',
    ...
    },
    {
      ...
      quote: 'جلسه‌ای که چشمم را به واقعیت‌هایی باز کرد که سال‌ها نادیده گرفته بودم.',
